...
public class NewCamActivity extends AppCompatActivity {

    private static final String TAG = "Camera_Video";
    ...
    private void startBackgroundThread() {
        mBackgroundHandlerThread = new HandlerThread("Camera_Video");
    ...
    private void createVideoFolder() {
        ...
        mVideoFolder = new File(movieFile, "Video_test");
